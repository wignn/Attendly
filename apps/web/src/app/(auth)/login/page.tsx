      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-200 p-6 sm:p-8 space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500">
              Gunakan email dan kata sandi yang diberikan administrator sekolah
            </p>
          </div>
          ...
          <div className="text-center pt-1">
            <p className="text-xs text-slate-500">
              Belum punya akun?{" "}
              <Link href="/register" className="font-bold text-[#0c3960] hover:underline">
                Daftar Akun Baru
              </Link>
            </p>
          </div>
        ...
        <div className="text-center text-[11px] text-slate-500 space-y-1">
          ...
          <p className="text-[10px] text-slate-400">
            Terhubung ke AbsenKu API • Versi 1.0.0
          </p>
        </div>
      </div>
    </div>
